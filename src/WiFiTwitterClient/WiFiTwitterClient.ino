...
char ssid[] = "BlackSwan_Portal"; //  your network SSID (name) 
char pass[] = "88288818";    // your network password (use for WPA, or use as key for WEP)
...
void connectToServer() {
  ...
  if (client.connect(server, 80)) {
    Serial.println("making HTTP POST to ThingSpeak...");
